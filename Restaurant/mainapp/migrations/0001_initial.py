# Generated by Django 3.2.5 on 2021-08-06 16:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='ОбщаяЦена')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='ОбщаяЦена')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_dishes', to='mainapp.cart', verbose_name='Корзина')),
        ...
        migrations.AddField(
            model_name='cart',
            name='dishes',
            field=models.ManyToManyField(blank=True, related_name='related_cart', to='mainapp.CartDishes'),
        ),
        migrations.AddField(
            model_name='cart',
            name='owner',
